...
### v1.5.6 (2026-08-10) - 주기별 업무 예정 시점 기간 범위(시작일~종료일) 표시 개선
- **FEAT**: 정기 업무에 시작일자/종료일자가 지정된 경우 예정 시점 표기방식 개편
  - 예: 단일일자 $\rightarrow$ `매월 11일`, `매주 월요일`, `매년 03월 15일`
  - 예: 기간범위 $\rightarrow$ `매월 11일~14일`, `매주 월요일~목요일`, `매분기 (03월 15일~03월 20일)`, `매년 03월 15일~03월 20일`
